      ...
      <el-row :gutter="20">
         ...
         <el-col :span="24" :xs="24">
            <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="100px">
               <el-form-item label="类型名称" prop="dbName">
                  <el-input v-model="queryParams.dbName" placeholder="请输入类型名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
               </el-form-item>
               <el-form-item label="类型名称" prop="dbName">
                  <el-input v-model="queryParams['condition[dbName|like]']" placeholder="请输入类型名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
               </el-form-item>
               <el-form-item>
            ...
            <el-table v-loading="loading" :data="CatalogList" @selection-change="handleSelectionChange">
               ...
               <!-- 业务字段-->
               <el-table-column label="类型名称" align="center" key="dbName" prop="dbName" v-if="columns[0].visible" />
               <el-table-column label="类型描述" align="center" key="dbDesc" prop="dbDesc" v-if="columns[1].visible" :show-overflow-tooltip="true" />
               ...
               <el-table-column label="类型地址" align="center" key="jdbcUrl" prop="jdbcUrl" v-if="columns[4].visible" width="120" />
            ...
            <el-row>
               <el-col :span="24">
                  <el-form-item label="名称" prop="dbName">
                     <el-input v-model="form.dbName" placeholder="请输入类型名称" maxlength="50" />
                  </el-form-item>
               </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
               ...
               <el-col :span="24">
                  <el-form-item label="密码" prop="dbPasswd">
                     <el-input v-model="form.dbPasswd" placeholder="请输入类型密码" type="password" maxlength="30" show-password />
                  </el-form-item>
               </el-col>
            </el-row>
            ...
            <el-row>
               <el-col :span="24">
                  <el-form-item label="备注" prop="dbDesc">
                     <el-input v-model="form.dbDesc" placeholder="请输入类型备注"></el-input>
                  </el-form-item>
               </el-col>
            </el-row>
         </el-form>
