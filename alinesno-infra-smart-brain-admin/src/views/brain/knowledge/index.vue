      ...
      <el-row :gutter="20">
         ...
         <el-col :span="24" :xs="24">
            <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="100px">
               <el-form-item label="知识库名称" prop="dbName">
                  <el-input v-model="queryParams.dbName" placeholder="请输入知识库名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
               </el-form-item>
               <el-form-item label="知识库名称" prop="dbName">
                  <el-input v-model="queryParams['condition[dbName|like]']" placeholder="请输入知识库名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
               </el-form-item>
               <el-form-item>
            ...
            <el-table v-loading="loading" :data="KnowledgeList" @selection-change="handleSelectionChange">
               ...
               <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
                  <template #default="scope">
                     <el-tooltip content="修改" placement="top" v-if="scope.row.KnowledgeId !== 1">
                        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                           v-hasPermi="['system:Knowledge:edit']"></el-button>
                     </el-tooltip>
                     <el-tooltip content="删除" placement="top" v-if="scope.row.KnowledgeId !== 1">
                        <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                           v-hasPermi="['system:Knowledge:remove']"></el-button>
                     </el-tooltip>
                  </template>
            ...
            <el-row>
               <el-col :span="24">
                  <el-form-item label="名称" prop="dbName">
                     <el-input v-model="form.dbName" placeholder="请输入知识库名称" maxlength="50" />
                  </el-form-item>
               </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
               ...
               <el-col :span="24">
                  <el-form-item label="密码" prop="dbPasswd">
                     <el-input v-model="form.dbPasswd" placeholder="请输入知识库密码" type="password" maxlength="30" show-password />
                  </el-form-item>
               </el-col>
            </el-row>
            ...
            <el-row>
               <el-col :span="24">
                  <el-form-item label="备注" prop="dbDesc">
                     <el-input v-model="form.dbDesc" placeholder="请输入知识库备注"></el-input>
                  </el-form-item>
               </el-col>
            </el-row>
         </el-form>
...
import {
   ...
   updateKnowledge,
   addKnowledge
} from "@/api/brain/smart/knowledge";
...
// 列显隐信息
const columns = ref([
   { key: 0, label: `知识库名称`, visible: true },
   { key: 1, label: `知识库描述`, visible: true },
   { key: 2, label: `表数据量`, visible: true },
   { key: 3, label: `类型`, visible: true },
   { key: 4, label: `知识库地址`, visible: true },
...
function getList() {
   loading.value = true;
   listKnowledge(proxy.addDateRange(queryParams.value, dateRange.value)).then(res => {
      loading.value = false;
...
function handleUpdate(row) {
   reset();
   const KnowledgeId = row.id || ids.value;
