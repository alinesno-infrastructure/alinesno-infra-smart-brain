...
// * 并使用线程池进行多线程导入，通过调用dataUploadToVectorDataset方法将数据集导入向量化，
// * 同时在任务执行过程中记录详细的日志信息到数据库中，便于后续对任务执行情况进行监控和分析。
// */
//@Slf4j
//@Component
//@EnableScheduling
//public class DatasetParseJobBak implements ApplicationListener<ApplicationReadyEvent> {
//
...
//
//    private ObjectPool<Runnable> taskPool;
...
//     */
//    public DatasetParseJobBak(IDatasetKnowledgeService datasetKnowledgeService, IDatasetParseLogService datasetParseLogService) {
...
//    /**
//     * 初始化线程池的方法。
//     * 在类实例化后，该方法会被自动调用，用于配置和初始化线程池的参数，
//     * 这里使用 Apache Commons Pool2 初始化任务对象池。
//     */
//    @PostConstruct
//    public void init() {
//        GenericObjectPoolConfig<Runnable> poolConfig = new GenericObjectPoolConfig<>();
//        poolConfig.setMinIdle(3);
//        poolConfig.setMaxIdle(5);
//        poolConfig.setMaxTotal(5);
//        taskPool = new GenericObjectPool<>(new RunnablePooledObjectFactory(), poolConfig);
//    }
//
//    @Override
...
//                    try {
//                        Runnable task = taskPool.borrowObject();
//                        task = () -> {
...
//
//    // 自定义的 Runnable 对象工厂类
//    private static class RunnablePooledObjectFactory extends org.apache.commons.pool2.BasePooledObjectFactory<Runnable> {
//
//        @Override
...
//
//        @Override
//        public PooledObject<Runnable> wrap(Runnable obj) {
