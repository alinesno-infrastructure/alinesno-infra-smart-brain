...
public class ParserDataBean {
    ...
    public ParserDataBean(String name, int sort , String type) {
        this.name = name;
        this.sort = sort;
        this.type = type ;
    }

    public ParserDataBean(String name, int sort , String type , String content) {
        this.name = name;
        this.sort = sort;
        this.type = type ;
        this.content = content ;
        this.textLength = String.valueOf(content.length());
    }
}
