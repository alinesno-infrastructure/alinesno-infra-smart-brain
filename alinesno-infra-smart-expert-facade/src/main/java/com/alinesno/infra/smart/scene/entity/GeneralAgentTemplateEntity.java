...
@TableName("general_agent_templates")
@Data
public class GeneralAgentTemplateEntity extends InfraBaseEntity {
    ...
    @ColumnComment("模板权限")
    @TableField(value = "long_text_template_permission")
    private String longTextTemplatePermission;
    ...
    public static GeneralAgentTemplateEntity toPower(InfraBaseEntity entity) {
        GeneralAgentTemplateEntity template = new GeneralAgentTemplateEntity();
