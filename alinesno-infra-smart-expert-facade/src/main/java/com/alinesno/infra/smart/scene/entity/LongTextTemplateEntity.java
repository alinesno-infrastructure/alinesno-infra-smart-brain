...
@TableName("long_text_templates")
@Data
public class LongTextTemplateEntity extends InfraBaseEntity {
    ...
    public static LongTextTemplateEntity toPower(InfraBaseEntity entity) {
        LongTextTemplateEntity template = new LongTextTemplateEntity();
