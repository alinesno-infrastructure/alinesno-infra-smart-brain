...
@RequestMapping("/api/infra/smart/assistant/agentScene")
public class AgentSceneController extends BaseController<AgentSceneEntity, IAgentSceneService> {
    ...
    @Override
    public IAgentSceneService getFeign() {
        return this.service;
    }
}
