...
@Slf4j
@Service(AssistantConstants.PREFIX_ASSISTANT + "BHIWVhzr")
public class AIPKubernetesStatusExpert extends ExpertService {
    ...
    protected String handleFunctionCall(IndustryRoleEntity role,
        ...
        String fileName = "应用所在K8S运维管理报告生成完成，请查看应用巡检报告" ;
