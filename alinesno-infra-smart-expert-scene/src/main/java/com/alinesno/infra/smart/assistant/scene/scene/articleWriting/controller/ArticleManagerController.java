...
@RequestMapping("/api/infra/smart/assistant/scene/articleManager")
public class ArticleManagerController extends BaseController<ArticleManagerEntity, IArticleManagerService> {

    @Autowired
    private IArticleManagerService service;
    ...
    @Override
    public IArticleManagerService getFeign() {
        return this.service;
    }
}