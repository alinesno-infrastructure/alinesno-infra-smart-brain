 ...
 * @version 1.0.0
 */
public interface IArticleWriterSceneService extends IBaseService<ArticleGenerateSceneEntity> {
     ...
     * @return
     */
    ArticleGenerateSceneEntity getBySceneId(long sceneId, PermissionQuery query);
