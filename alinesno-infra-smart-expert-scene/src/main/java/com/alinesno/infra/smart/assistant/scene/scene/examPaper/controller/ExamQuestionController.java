...
@RequestMapping("/api/infra/smart/assistant/scene/examQuestion")
public class ExamQuestionController extends BaseController<ExamQuestionEntity, IExamQuestionService> {
    ...
    @Override
    public IExamQuestionService getFeign() {
        return this.service;
    }
}
