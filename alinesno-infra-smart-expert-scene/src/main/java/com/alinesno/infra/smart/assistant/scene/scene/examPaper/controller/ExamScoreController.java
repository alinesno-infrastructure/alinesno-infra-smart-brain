...
@RequestMapping("/api/infra/smart/assistant/scene/examScore")
public class ExamScoreController extends BaseController<ExamScoreEntity, IExamScoreService> {

    @Autowired
    private IExamScoreService service;
    ...
    @Override
    public IExamScoreService getFeign() {
        return this.service;
    }
}
