...
@Slf4j
@Component
public class GeneralAgentChatRoleUtil {
    ...
    public CompletableFuture<AiMessage> chat(IndustryRoleDto roleDto, TextChatEditorDto dto, PermissionQuery query) {
        ...
        AgentSceneEntity agentSceneEntity =  agentSceneService.getByRoleAndScene(roleDto.getId() , SceneEnum.GENERAL_AGENT.getSceneInfo().getId()) ;
        ...
        // 处理附件
        GeneralAgentTaskEntity longTextTaskEntity = generalAgentTaskService.getById(dto.getTaskId());
