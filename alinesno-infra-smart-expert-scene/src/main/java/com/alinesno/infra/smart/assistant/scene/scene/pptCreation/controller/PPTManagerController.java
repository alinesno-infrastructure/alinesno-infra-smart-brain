...
@RequestMapping("/api/infra/smart/assistant/scene/pptManager")
public class PPTManagerController extends BaseController<PPTManagerEntity, IPPTManagerService> {

    @Autowired
    private IPPTManagerService service;
    ...
    @Override
    public IPPTManagerService getFeign() {
        return this.service;
    }
}