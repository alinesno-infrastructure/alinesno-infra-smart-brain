...
public class ProjectKnowledgeGroupController extends BaseController<ProjectKnowledgeGroupEntity, IProjectKnowledgeGroupService> {
    ...
    public AjaxResult listGroup(PermissionQuery query , @RequestParam(value = "sceneId") Long sceneId) {
        List<ProjectKnowledgeGroupDto> list = service.listGroup(query, sceneId) ;
