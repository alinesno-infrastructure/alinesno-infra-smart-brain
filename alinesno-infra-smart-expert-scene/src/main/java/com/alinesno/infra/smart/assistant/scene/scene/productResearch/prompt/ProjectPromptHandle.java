...
public class ProjectPromptHandle {
   ...
   private final static String PROMPT_DESIGN_OUTLINE_ZH = """
           ...
           - 中等复杂度：拆分为5-10个部分（如"AI对医疗的影响"）
           - 高复杂度：拆分为5-20个部分（如"财富500CEO背景调查"）
           重要原则：避免超过20个拆分部分，优先使用能力更强的少量子代理
           ...
           ##规则：
            ...
            5-在编写要求中，要求要写详细明确，具备有指导性，请你根据用户的文字总数进行计算，对每一个部分创作具体内容时候要求的字数，给出要求。如果用户没有给出字数要求，每一部分给出合理的字数要求。
