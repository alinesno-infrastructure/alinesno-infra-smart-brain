...
import com.alinesno.infra.smart.assistant.scene.scene.productResearch.mapper.ProjectKnowledgeGroupMapper;
...
public class ProjectKnowledgeGroupServiceImpl extends IBaseServiceImpl<ProjectKnowledgeGroupEntity, ProjectKnowledgeGroupMapper> implements IProjectKnowledgeGroupService {
    ...
    @Override
    public List<ProjectKnowledgeGroupDto> listGroup(PermissionQuery query, Long sceneId) {
        ...
        wrapper.eq(ProjectKnowledgeGroupEntity::getSceneId, sceneId);
