...
const footerMenuItems = ref([
  { id: '13', icon: 'fa-solid fa-computer', link: '/smart/assistant/llmModel/index', desc: '模型'},
  { id: '22', icon: 'fa-brands fa-wordpress',  link: '/monitor/smart/assistant/analyse/index', desc: '监控' },
])
