<template>
  <div class="parse-config">
    <el-button type="primary" text bg @click="addOfficeTool" icon="Plus" class="mb-20">添加解析服务</el-button>

    <el-table :data="officeTools" style="width: 100%">
      <!-- 序号 -->
      ...
      <el-table-column label="操作" align="center" width="200">
        <template #default="{row}">
          <el-button type="primary" text bg @click="editOfficeTool(row)">编辑</el-button>
          <el-button type="danger" text bg @click="deleteOfficeTool(row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>

    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="600">
      <el-form :model="currentTool" size="large" label-width="100px">
      ...
      <template #footer>
        ...
        <el-button size="large" type="primary" @click="saveOfficeTool">保存</el-button>
      </template>
    </el-dialog>
  </div>
</template>
