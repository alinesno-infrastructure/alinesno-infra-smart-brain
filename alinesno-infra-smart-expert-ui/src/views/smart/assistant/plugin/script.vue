<template>
    <div class="app-container">
        <el-page-header @back="goBack" :content="'['+ currentTool.name +']工具脚本配置'">
        </el-page-header>
...
function getToolInfo() {
    currentToolId.value = router.currentRoute.value.query.toolId; 
    getTool(currentToolId.value).then(response => {
