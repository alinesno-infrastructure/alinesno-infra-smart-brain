<template>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="21" :xs="24">
        ...
        <el-table v-loading="loading" :data="ArticleTemplateList" @selection-change="handleSelectionChange">
          ...
          <!--
          <el-table-column label="模板类型" align="center" key="articleTemplateType" width="150" prop="pluginType"
            v-if="columns[2].visible" :show-overflow-tooltip="true">
            <template #default="scope">
              {{ getPluginTypeName(scope.row.articleTemplateType) }}
            </template>
          </el-table-column>
          -->
    ...
    <el-dialog :title="title" v-model="open" width="900px" append-to-body>
      <el-form :model="form" :rules="rules" ref="ArticleTemplateRef" label-width="80px">
        <el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="Prompt" prop="prompt">
              <el-input type="textarea" v-model="form.prompt" :rows="8" placeholder="模板指令信息" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
