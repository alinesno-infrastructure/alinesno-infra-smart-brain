      ...
      <el-row :gutter="20">
         ...
         <el-col :span="24" :xs="24">
            <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="100px">
               <el-form-item label="记录名称" prop="dbName">
                  <el-input v-model="queryParams.dbName" placeholder="请输入记录名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
               </el-form-item>
               <el-form-item label="记录名称" prop="dbName">
                  <el-input v-model="queryParams['condition[dbName|like]']" placeholder="请输入记录名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
               </el-form-item>
               <el-form-item>
            ...
            <el-table v-loading="loading" :data="RecordList" @selection-change="handleSelectionChange">
               ...
               <!-- 业务字段-->
               <el-table-column label="记录名称" align="center" key="dbName" prop="dbName" v-if="columns[0].visible" />
               <el-table-column label="记录描述" align="center" key="dbDesc" prop="dbDesc" v-if="columns[1].visible" :show-overflow-tooltip="true" />
               ...
               <el-table-column label="记录地址" align="center" key="jdbcUrl" prop="jdbcUrl" v-if="columns[4].visible" width="120" />
               ...
               <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
                  <template #default="scope">
                     <el-tooltip content="修改" placement="top" v-if="scope.row.RecordId !== 1">
                        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                           v-hasPermi="['system:Record:edit']"></el-button>
                     </el-tooltip>
                     <el-tooltip content="删除" placement="top" v-if="scope.row.RecordId !== 1">
                        <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                           v-hasPermi="['system:Record:remove']"></el-button>
                     </el-tooltip>
                  </template>
            ...
            <el-row>
               <el-col :span="24">
                  <el-form-item label="名称" prop="dbName">
                     <el-input v-model="form.dbName" placeholder="请输入记录名称" maxlength="50" />
                  </el-form-item>
               </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
               ...
               <el-col :span="24">
                  <el-form-item label="密码" prop="dbPasswd">
                     <el-input v-model="form.dbPasswd" placeholder="请输入记录密码" type="password" maxlength="30" show-password />
                  </el-form-item>
               </el-col>
            </el-row>
            ...
            <el-row>
               <el-col :span="24">
                  <el-form-item label="备注" prop="dbDesc">
                     <el-input v-model="form.dbDesc" placeholder="请输入记录备注"></el-input>
                  </el-form-item>
               </el-col>
            </el-row>
         </el-form>
...
const columns = ref([
   ...
   { key: 1, label: `记录描述`, visible: true },
   { key: 2, label: `表数据量`, visible: true },
   { key: 3, label: `类型`, visible: true },
   { key: 4, label: `记录地址`, visible: true },
...
function getList() {
   loading.value = true;
   listRecord(proxy.addDateRange(queryParams.value, dateRange.value)).then(res => {
      loading.value = false;
...
function handleDelete(row) {
   ...
   proxy.$modal.confirm('是否确认删除记录编号为"' + RecordIds + '"的数据项？').then(function () {
...
function handleUpdate(row) {
   reset();
   const RecordId = row.id || ids.value;
