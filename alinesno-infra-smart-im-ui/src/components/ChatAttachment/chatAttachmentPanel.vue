<template>
  ...
  <div class="chat-attachment-actions" v-if="uploadedFiles.length != 0">
    <el-button type="info" size="small" class="chat-attachment-action-btn" bg text style="margin-right:10px;" @click="sendAttachmentActionTxt('解析内容')">
      解析内容
      <el-icon><Right /></el-icon>
    </el-button>

    <!--如果类型有图片的显示这个 -->
    <el-button type="info" v-if="hasImage"  class="chat-attachment-action-btn" size="small" bg text @click="sendAttachmentActionTxt('解析图片内容')">
      解析图片内容
      <el-icon><Right /></el-icon>
    </el-button>
    ...
    <el-button type="info" size="small"  class="chat-attachment-action-btn" bg text @click="sendAttachmentActionTxt('总结这份文档内容')">
      总结这份文档内容
      <el-icon><Right /></el-icon>
    </el-button>
    <el-button type="info" size="small"  class="chat-attachment-action-btn" bg text @click="sendAttachmentActionTxt('说说文档讲了什么')">
      说说文档讲了什么
      <el-icon><Right /></el-icon>
    </el-button>
      </div>
...
import { uploadFile } from '@/api/base/im/roleChat';
