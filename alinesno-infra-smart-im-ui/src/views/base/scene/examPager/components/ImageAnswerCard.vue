  ...
  <div 
    ...
    <div v-if="!isEditing" class="editable-card-content" @click="handleClick">
      <div class="image-wrapper">
        <img v-if="item.img" :src="item.img" class="image-preview" />
    ...
    <div v-else class="editable-card-edit">
      ...
      <el-upload
        ...
        <img v-if="item.img" :src="item.img" class="uploaded-image" />
      ...
      <el-upload
        ...
        <template #trigger>
          <div class="upload-area">
            ...
            <img v-else-if="editData.img" :src="editData.img" class="uploaded-image" />
...
const handleMouseLeave = () => {
  // Only exit edit mode if not in the process of uploading/editing
