<template>
  <div class="ppt-function-panel">
    <div class="title">
      <i class="fa-solid fa-graduation-cap"></i> PPT一键生成
    </div>
    <div class="add-task">
      <router-link :to="'/scene/pptCreation/index?sceneId=' + sceneId">
        <el-button type="primary" text bg size="large" style="width:100%;">
          <i class="fa-solid fa-plus"></i> 新建PPT
        </el-button>
      </router-link>
    </div>
    <div class="task-list">
...
const functionList = ref([
  {
    ...
    "log": "已完成 PPT 上传与分类管理",
    "isSelected": false,
    "link": "/scene/pptCreation/pptManager"
  }
])
