          ...
          <el-row>
            <el-col :span="11">
              ...
              <div class="title-section">
                <span class="title">
                  <i class="fa-solid fa-file-powerpoint"></i> 一键生成PPT满足多样化场景需求
                </span>
                <span class="description">
                  依托智能设计助手，精准聚焦演示痛点，输入主题/风格，快速生成专业演示方案
                </span>
              </div>
            ...
            <el-col :span="13">
              <div class="review-question-preview-title">
                <span>
                  <i class="fa-solid fa-file-pdf"></i> 大纲生成预览
                </span>
              ...
              <div class="pager-gen-result-panel">
                ...
                <div v-if="!outline" style="margin-top: 10vh;">
                  <el-empty description="当前未生成PPT大纲，可以上传相关文档和配置场景，生成PPT大纲" />
                </div>
