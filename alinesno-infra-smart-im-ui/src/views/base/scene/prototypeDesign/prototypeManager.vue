              ...
              <div class="channel-container-panel" style="margin-top:20px">
                <el-row>
                  <el-col :span="6" v-for="(item, index) in pagerList" :key="index" style="padding:8px;">
                    <div class="exam-pager-card-container" @click="prototypeEditor(item)">
...
import SideTypePanel from './prototypeType.vue'
...
/** 进入长文本编辑界面 */
function prototypeEditor(item) {
  const path = '/scene/prototypeDesign/prototypeParser';
  router.push({
    path: path,
    query: { 
      'genStatus': true ,
      'channelStreamId': '7335538396204371968',
